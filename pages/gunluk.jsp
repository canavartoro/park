...
<script type="text/javascript">
    ...
    <%@include file="../adapter/jsp/outer.jsp" %>
		...
		var firmaStore = new Ext.data.Store({
			reader: new Ext.data.JsonReader({
            fields: [
			{"type": "string", "mapping": "tanim", "name": "tanim"}, 
			{"type": "string", "mapping": "stok", "name": "stok"},
			{"type": "int", "mapping": "miktar", "name": "miktar"},
			{"type": "int", "mapping": "adet", "name": "adet"}
			],
            root: 'rows',
            baseParams: {
                action:   'gunluk',
        ...
        var pagingToolbar = { //1
            ...
            items : [
                '-',
                {
					...
					var stk = Ext.get('comboStk').getValue();
                        ...
                        var winHandle = window.open('adapter/jsp/gunluk.jsp' +
                            ...
                            "&bitis=" + formatDate(new Date(dateBitis.getValue()),'yyyy-MM-dd') +
							"&bassaat=" + bass + "&bitsaat=" + bits + "&stok_tip=" + stk, "_top", "width=600" +
                            ",height=800" +
            ...
            bbar    : [
				...
				endTimePicker,
                {
                    ...
                    handler:function() {
						...
						var bsaat = startTimePicker.getValue();
						var bitsaat = endTimePicker.getValue();
						var stk = Ext.get('comboStk').getValue();
