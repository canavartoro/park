...
<div id="cihaz-win" style="width: 100%;height: 100%;position: relative;margin: 0px 0px;"></div>
...
<script type="text/javascript">
    ...
    Ext.onReady(function(){
        ...
        var cihazDelete = function(forDelete) {
            ...
            var grid = Ext.getCmp('cihazGrid');
            grid.el.mask('Siliniyor', 'x-mask-loading'); // 3
            grid.stopEditing();
            Ext.Ajax.request({
                url : 'adapter/jsp/cihaz_tanim.jsp',
                params : {
                    action : 'delete1',
		...
		Ext.Ajax.request({
            ...
            reader: new Ext.data.JsonReader({
                id: 'id',
                fields: ['id', 'kod', 'adres', 'firma', 'durum', 'kayit_tarihi', 'kayit_kullanici', 'update_tarihi', 'update_kullanici'],
                root: 'rows'
            }),
            proxy: new Ext.data.HttpProxy({
                url: 'adapter/jsp/cihaz_tanim.jsp?action=cihaz'
            }),
            autoLoad: true
        });
            ...
            items : [
                '-', 
                {
                    ...
                    handler: function() {
                        ...
                        0,//id, kod, adres, firma, durum, kayit_tarihi, kayit_kullanici, update_tarihi, update_kullanici
                        new ds_model({
                            id:'', kod:'', adres:'', firma:'', durum:true, kayit_tarihi:'', kayit_kullanici:'', update_tarihi:'', update_kullanici:''                        })
                    );
